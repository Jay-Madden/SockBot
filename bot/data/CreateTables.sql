...
(
    pin_message_id              INTEGER,                            -- Discord Message ID (Generated by SockBot)
    original_post_message_id    INTEGER,                            -- Discord Message ID (The message to be pinned) or NULL
    ...
    PRIMARY KEY (pin_message_id, channel_id),
