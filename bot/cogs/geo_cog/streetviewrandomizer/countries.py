...
countries_codes = {
    "iso3": (
        # Custom Locations
        "BLL", # Berlin, Germany
        "CWN", # Cape Town, South Africa
        "SPO", # Sao Paulo, Brazil
        "BOO", # Bogota, Colombia
        "ATL", # Atlanta, USA
        "TOT", # Toronto, Canada
        "DET", # Detroit, USA
        "PJT", # Pretoria, South Africa
        "PXA", # Paris, France
        "TKY", # Tokyo, Japan
        "TLL", # Tel Aviv-Yafo, Israel
        "AAA", # Athens, Greece
        "MMM", # Miami, USA
        "HST", # Houston, USA
        "PWJ", # Philadelphia, USA (with suburbs in Delaware/New Jersey)
        "STD", # Santo Domingo, Dominican Republic
        "MSW", # Moscow, Russia
        "CBA", # Curitiba, Brazil
        # Antarctica
        "ATA",
